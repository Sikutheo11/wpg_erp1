...
urlpatterns = [
    ...
    path('income-declarations/<int:pk>/document/', views.income_declaration_document, name='income_declaration_document'),
    ...
    path('expense-requests/<int:pk>/documents/<str:kind>/', views.expense_request_document, name='expense_request_document'),
